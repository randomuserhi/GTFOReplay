...
using Vanilla.EnemyProjectile.BepInEx;

namespace Vanilla.EnemyProjectile.BepInEx {
    // REMEMBER TO SET THESE => otherwise program just wont work lmao
    public static class Module {
        public const string GUID = "randomuserhi.ReplayRecorder.Vanilla.EnemyProjectile";
        public const string Name = "ReplayRecorder.Vanilla.EnemyProjectile";
