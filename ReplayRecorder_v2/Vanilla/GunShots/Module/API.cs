...
using Vanilla.Player.Gunshots.BepInEx;

namespace Vanilla.Player.Gunshots.BepInEx {
    // REMEMBER TO SET THESE => otherwise program just wont work lmao
    public static class Module {
        public const string GUID = "randomuserhi.ReplayRecorder.Vanilla.Player.Gunshots";
        public const string Name = "ReplayRecorder.Vanilla.Player.Gunshots";
