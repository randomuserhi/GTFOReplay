...
using Vanilla.Specification.BepInEx;

namespace Vanilla.Specification.BepInEx {
    // REMEMBER TO SET THESE => otherwise program just wont work lmao
    public static class Module {
        public const string GUID = "randomuserhi.ReplayRecorder.Vanilla.Specification";
        public const string Name = "ReplayRecorder.Vanilla.Specification";
