...
using Vanilla.EnemyTongue.BepInEx;

namespace Vanilla.EnemyTongue.BepInEx {
    // REMEMBER TO SET THESE => otherwise program just wont work lmao
    public static class Module {
        public const string GUID = "randomuserhi.ReplayRecorder.Vanilla.EnemyTongue";
        public const string Name = "ReplayRecorder.Vanilla.EnemyTongue";
