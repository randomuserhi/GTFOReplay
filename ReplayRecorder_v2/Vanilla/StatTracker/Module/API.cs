...
using Vanilla.StatTracker.BepInEx;

namespace Vanilla.StatTracker.BepInEx {
    // REMEMBER TO SET THESE => otherwise program just wont work lmao
    public static class Module {
        public const string GUID = "randomuserhi.ReplayRecorder.Vanilla.StatTracker";
        public const string Name = "ReplayRecorder.Vanilla.StatTracker";
