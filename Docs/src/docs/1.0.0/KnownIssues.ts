RHU.require(new Error(), { 
    ...
    docs.jit = () => docuscript<RHUDocuscript.Language, RHUDocuscript.FuncMap>((lib) => {
        ...
        p(
            "Since GTFO has a problem with C-Foam falling through floors, the replay discards any C-Foam blobs that do not have supporting geometry below it. For this reason, C-Foam fired over",
            " gaps does not get recorded."
        );
