RHU.require(new Error(), { 
    ...
    docs.jit = () => docuscript<RHUDocuscript.Language, RHUDocuscript.FuncMap>((lib, include) => {
        ...
        ul(
            "Visual shots are purely aesthetic and are non-representative of whether a player hit an enemy or not.",
            frag("By setting this to ", ic([], "false"), " you can see exactly what players hit, but you cannot see missed shots etc...")
        );
        br();
