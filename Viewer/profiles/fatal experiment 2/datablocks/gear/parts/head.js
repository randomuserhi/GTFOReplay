...
GearPartHeadDatablock.set(16, {
  path: `${root}/../Handle/Handle_Hammer_4.glb`,
  aligns: []
});
GearPartHeadDatablock.set(18, {
  path: `${root}/InfectionSpitter.glb`,
  aligns: []
});
GearPartHeadDatablock.set(20, {
  path: `${root}/DisinfectonPack.glb`,
  aligns: []
});
GearPartHeadDatablock.set(19, {
  path: `${root}/HSUSmall_FirstPerson_Stage_3.glb`,
  aligns: []
});
