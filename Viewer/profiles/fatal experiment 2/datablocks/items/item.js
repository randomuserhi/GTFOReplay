...
ItemDatablock.set(Identifier.create("Item", 221), { ...GlowSticks, name: "Hope" });
...
ItemDatablock.set(Identifier.create("Item", 115), CfoamGrenade);
ItemDatablock.set(Identifier.create("Item", 214), CfoamGrenade);
ItemDatablock.set(Identifier.create("Item", 220), CfoamGrenade);
...
ItemDatablock.set(Identifier.create("Item", 218), {
  type: "consumable",
  name: "Cfoam Tripmine Bundle",
  model: () => {
    const model = new ItemGLTFModel("../js3party/models/Consumables/ctrip.glb", () => {
      model.gltf.position.set(0, 0.05, 0);
    }, false);
...
ItemDatablock.set(Identifier.create("Item", 138), HisecCargoCrate);
...
ItemDatablock.set(Identifier.create("Item", 93), {
  type: "rifle",
  name: "Key Gold",
  serial: "KEY_GOLD",
  model: () => new Keycard(0xb300ff)
});
ItemDatablock.set(Identifier.create("Item", 94), {
  type: "rifle",
  name: "Key Brown",
  serial: "KEY_BROWN",
  model: () => new Keycard(0xb300ff)
...
ItemDatablock.set(Identifier.create("Item", 129), Decoder);
ItemDatablock.set(Identifier.create("Item", 217), { ...Decoder, name: "Corrupted Decoder" });
const HardDrive = {
  type: "rifle",
  name: "Hard Drive",
  model: () => {
