...
ItemDatablock.set(Identifier.create("Item", 221), { ...GlowSticks, name: "Throwable Sun" });
...
ItemDatablock.set(Identifier.create("Item", 115), CfoamNade);
ItemDatablock.set(Identifier.create("Item", 214), CfoamNade);
ItemDatablock.set(Identifier.create("Item", 220), CfoamNade);
...
ItemDatablock.set(Identifier.create("Item", 139), ConsumableMine);
ItemDatablock.set(Identifier.create("Item", 219), { ...ConsumableMine, name: "Explosive Tripmine Bundle" });
const CfoamTrip = {
  type: "consumable",
  name: "Cfoam Tripmine",
  model: () => {
...
ItemDatablock.set(Identifier.create("Item", 144), CfoamTrip);
ItemDatablock.set(Identifier.create("Item", 218), { ...CfoamTrip, name: "Cfoam Tripmine Bundle" });
...
ItemDatablock.set(Identifier.create("Item", 129), PartialDecoder);
ItemDatablock.set(Identifier.create("Item", 217), { ...PartialDecoder, name: "Corrupted Decoder", serial: "CDEC" });
const HardDrive = {
  type: "rifle",
  name: "Hard Drive",
  model: () => {
