...
GearPartStockDatablock.set(22, {
    path: `${root}/STOCK_93R_1.PREFAB.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"Magazine","alignName":"a_mag"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(100, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});
GearPartStockDatablock.set(101, {
    path: `${root}/Stock_Bullpop_1.glb`,
    aligns: [{"alignType":"Magazine","alignName":"a_Mag"},{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(121, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"Magazine","alignName":"a_Mag"},{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(102, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});
GearPartStockDatablock.set(103, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});
GearPartStockDatablock.set(104, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});
GearPartStockDatablock.set(105, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"Magazine","alignName":"Stock_Mag"},{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(106, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"Magazine","alignName":"a_mag"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(110, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});
GearPartStockDatablock.set(112, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"Magazine","alignName":"a_Mag"},{"alignType":"RightHand","alignName":"RightHand"},{"alignType":"LeftHand","alignName":"LeftHand"}]
});
GearPartStockDatablock.set(113, {
    path: `${root}/Stock.glb`,
    aligns: [{"alignType":"RightHand","alignName":"RightHand"}]
});