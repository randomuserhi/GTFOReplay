...
GearPartReceiverDatablock.set(24, {
...
// These models dont actually exist in duo trials - Zaero forgot to include the asset bundle xD
/*
GearPartReceiverDatablock.set(23, {
    path: `${root}/RECIEVER_SOCOM.glb`, // ASSETS/BUNDLE/SOCOM/CONTENT/RECIEVER_SOCOM.PREFAB
    aligns: [{"alignType":"Flashlight","alignName":"Front_Flash"}]
});
GearPartReceiverDatablock.set(100, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(101, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(102, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(103, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(104, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(105, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(106, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: []
});
GearPartReceiverDatablock.set(110, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(112, {
    path: `${root}/Receiever.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});
GearPartReceiverDatablock.set(113, {
    path: `${root}/Receiver.glb`, // Assets/ProjectZaero/AssaultRifleA/Receiver.prefab
    aligns: [{"alignType":"Sight","alignName":"Receiver_Sight"}]
});*/