...
import { Anim, AnimBlend, AnimFunc, Avatar, AvatarLike, AvatarMask, AvatarSkeleton, AvatarStructure, empty } from "../../library/animations/lib.js";
...
export const humanEmptyAnim: HumanAnim = empty(HumanJoints);