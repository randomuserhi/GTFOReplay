import { GearPartHandleDatablock } from "../../../../vanilla/datablocks/gear/parts/handle.js";
...
GearPartHandleDatablock.set(17, {
    path: `${root}/Handle_Bat_2.glb`,    
});
GearPartHandleDatablock.set(15, {
    path: `${root}/Handle_Spear_1.glb`,    
});
GearPartHandleDatablock.set(18, {
    path: `${root}/Handle_Spear_2.glb`,    
});
GearPartHandleDatablock.set(14, {
    path: `${root}/Handle_Knife_1.glb`,    
});
GearPartHandleDatablock.set(19, {
    path: `${root}/Handle_Knife_2.glb`,    
});
