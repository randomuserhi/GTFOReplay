...
declare module "@/rhu/macro.js" {
    interface TemplateMap {
        "atoms/icons/stats": MacroWrapper<SVGElement>;
    }
}

export const stats = Macro(MacroWrapper<SVGElement>, "atoms/icons/stats", //html
    `
    ...
    `, {
        element: //html
        `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-3 0 32 32" version="1.1"></svg>`
    });