...
import { Anim, AnimBlend, AnimFunc, mergeAnims, ScaledAnim } from "../../renderer/animations/lib.js";
...
export const EnemyAnimDatablock: Datablock<EnemyAnimationClips | EnemyAnimations, AnimFunc<HumanJoints>> = new Datablock();
...
type EnemyAnimationClips = typeof enemyAnimationClipNames[number];
...
type EnemyAnimations = keyof typeof enemyAnimations;
